...
import {
    ...
    faPen,
    faStopwatch,
    faClockRotateLeft, faCalendarDays, faFlag, faCheck, faDice, faCamera, faDoorOpen, faKey, faLink, faQ, faA
...
library.add(faCopy, faUser, faClock, faMemory, faCircleRight, faCircleCheck,
    ...
    faCalendarDays, faFlag, faCheck, faDice, faCamera, faDoorOpen, faKey, faLink, faQ,
    faA)
